...
### Learning goal
- What you are practicing: Build `Mini grep` like a real command-line tool: clear arguments, stream-friendly I/O, and predictable errors.
...
- When correct: When your solution is correct, it should satisfy: `implement subset of unix grep`; `no os.Exit`; and `return errors`.
...
- This kata is focused practice in CLI, IO through `Mini grep`.
