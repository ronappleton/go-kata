...
### Learning goal
- What you are building: Build `func Throttle(d time.Duration, in <-chan struct{}) <-chan struct{}` as a reliable contract. Focus: Time, channels.
...
- Definition of done (plain English): A reviewer should be able to confirm this behavior in tests: max 1 event per period; and drop extras.
