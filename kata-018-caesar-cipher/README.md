...
### Learning goal
- What you are building: Build `func Caesar(s string, shift int) string` as a reliable contract. Focus: ASCII letters shifting.
...
- Definition of done (plain English): A reviewer should be able to confirm this behavior in tests: only shift a-z and a-z; preserve case; and non-letters unchanged.
